...
def generate_atks(model_atk, eps=0.06, eps2=0.1, avoid_attack=-1):
    ...
    if avoid_attack != 0:
        ...
        atks_list.append(FGSM_(model_atk, eps=eps, transf=log_transf))
    else:
        print("Not trainning on FGSM")
    ...
    if avoid_attack != 1:
        ...
        atks_list.append(FFGSM_(model_atk, eps=eps, transf=log_transf))
    else:
        print("Not trainning on FFGSM")
    ...
    if avoid_attack != 2:
        ...
        atks_list.append(PGD_(model_atk, eps=eps, transf=log_transf))
    else:
    ...
    if avoid_attack != 3:
        ...
        atks_list.append(PGDL2_(model_atk, eps=eps2, transf=log_transf))
    else:
